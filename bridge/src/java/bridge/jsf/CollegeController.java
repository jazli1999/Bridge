...
import bridge.ejb.CollegeFacade;
...
public class CollegeController implements Serializable {
    ...
    @EJB
    private CollegeFacade ejbFacade;
    ...
    public String getItemsByCollegeSearch() {
        ...
        pagination = new PaginationHelper(10) {
            ...
            @Override
            public DataModel createPageDataModel() {
                return ejbFacade.createPageDataModelByCollegeSearch();
            }
        };
